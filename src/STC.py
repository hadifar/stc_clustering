...
if __name__ == "__main__":
    ...
    parser.add_argument('--ae_weights',
                        default='/Users/mac/PycharmProjects/stc_clustering/data/search_snippets/results2/ae_weights.h5')
    parser.add_argument('--save_dir',
                        default='/Users/mac/PycharmProjects/stc_clustering/data/search_snippets/results2')
